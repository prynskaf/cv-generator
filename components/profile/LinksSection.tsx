...
interface LinksSectionProps {
  links: Links
  saving: boolean
  onChange: (field: keyof Links, value: string) => void
  onSave: () => void
}

export default function LinksSection({ links, saving, onChange, onSave }: LinksSectionProps) {
      ...
      {isExpanded && (
        <div className="p-6 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition"
          ...
          <button
            onClick={onSave}
            disabled={saving}
            className="mt-6 w-full px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-xl hover:from-cyan-700 hover:to-blue-700 transition shadow-md disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {saving ? (
              <>
