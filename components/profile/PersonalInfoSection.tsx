...
export default function PersonalInfoSection({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 mb-6 overflow-hidden">
      {/* Header */}
      <div 
        className="flex items-center justify-between p-4 sm:p-6 cursor-pointer bg-gradient-to-r from-indigo-50 to-blue-50 hover:from-indigo-100 hover:to-blue-100 transition"
      ...
      >
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-600">{fullName || 'Add your details'}</p>
          </div>
        </div>
      ...
      {isExpanded && (
        <div className="p-6 sm:p-8 border-t border-gray-200">
          ...
          <button
            onClick={onSave}
            disabled={saving}
            className="mt-6 w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed transition-all transform hover:scale-[1.02] text-sm sm:text-base"
          >
            {saving ? (
