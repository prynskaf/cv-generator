    ...
    <div className="border-2 border-gray-200 rounded-xl overflow-hidden hover:border-blue-300 transition bg-white">
      ...
      >
        <div className="flex-1 min-w-0 pr-2">
          <h3 className="font-bold text-sm sm:text-base text-gray-900 truncate">{skill.skill_name || 'New Skill'}</h3>
          <p className="text-xs text-gray-600 truncate">{skill.skill_level || 'Level'}</p>
        </div>
