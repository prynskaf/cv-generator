    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 mb-6 border border-gray-100">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm">Upload a professional photo for your CV</p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
        ...
        <div className="relative">
          {profilePictureUrl ? (
            ...
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center border-4 border-gray-200">
