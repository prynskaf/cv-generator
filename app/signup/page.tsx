      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-gray-100">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Start creating professional CVs today</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="font-semibold text-blue-600 hover:text-purple-600 transition">
                Sign in
              </Link>
            </p>
          </div>
